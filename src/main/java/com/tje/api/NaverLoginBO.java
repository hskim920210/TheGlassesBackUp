...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "8wvitOt0n6CWt2PyZN_M";
	private final static String CLIENT_SECRET = "LYLhUkkkkq";
	private final static String REDIRECT_URI = "http://localhost:8080/webapp/naver_callback";
